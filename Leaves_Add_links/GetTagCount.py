...
def getTagCount():
    ...
    cursor.execute("select wt.id as id, wt.label as label, wt.slug as slug, count(1) as no_of_links from wallabag_entry_tag wet, wallabag_tag wt where wt.id = wet.tag_id group by wt.label")
