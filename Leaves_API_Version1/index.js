...
resizeImg(fs.readFileSync('imageout.png'), {width: 2048, height: 898}).then(buf => {
...
resizeImg(fs.readFileSync('imageout.png'), {width: 1024, height: 449}).then(buf => {
    fs.writeFileSync('imageout-MEDIUM.png', buf);
...
resizeImg(fs.readFileSync('imageout.png'), {width: 512, height: 224}).then(buf => {
    fs.writeFileSync('imageout-SMALL.png', buf);
